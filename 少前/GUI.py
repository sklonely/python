...
LAB = tk.Label(window, text="▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬").place(
    x=0, y=70, anchor='nw')
LAB1 = tk.Label(window, text="《 後勤相關 》"+"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬✪✪✪▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬" +
                "《 戰役相關  》").place(x=20, y=100, anchor='nw')
# 4大空格字典
T2L = {0: tk.Entry(window), 1: tk.Entry(window),
       2: tk.Entry(window), 3: tk.Entry(window)}
T2R = {0: tk.Entry(window), 1: tk.Entry(window),
       2: tk.Entry(window), 3: tk.Entry(window)}
waveL = {0: tk.Entry(window), 1: tk.Entry(
    window), 2: tk.Entry(window), 3: tk.Entry(window)}
waveR = {0: tk.Entry(window), 1: tk.Entry(
    window), 2: tk.Entry(window), 3: tk.Entry(window)}
# 排版迴圈
for i in range(4):
    for j in range(9):
...
def move_click(x, y):  # 移動後點
    ...
    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN |
                         win32con.MOUSEEVENTF_LEFTUP, 10, 10)
